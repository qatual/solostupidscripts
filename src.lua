...
Logo.Image = getcustomasset("https://solo.booty.hair/rizzy/q.gif")
...
PluginsHint.Text = "Download plugins from the IY Discord (discord.gg/unblockedsites)"
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Unstable Device", "On mobile, Solos Stupid Scripts may have issues or features that are not functioning correctly.") end
end)
